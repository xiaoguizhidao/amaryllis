...
class Commercebug_Packager
{
    ...
    {
        $string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Teninteractivellc_Commercebug><active>true</active><codePool>local</codePool></Teninteractivellc_Commercebug></modules></config>';
        $string = str_replace('Teninteractivellc_', $this->namespace . '_',$string);
