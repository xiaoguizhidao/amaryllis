...
*/
class Teninteractivellc_Commercebug_Model_Collectorblocksandlayout extends Teninteractivellc_Commercebug_Model_Observingcollector
{
    ...
    {		
        ...
        foreach($this->_blocks as $block)
        {
            ...
            if(strpos($class,'Teninteractivellc_Commercebug') === 0)
            {
                continue;
            }
