    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
     ...
     */
     public function getCode($type, $code = '')
     {
        $codes = array(
             'method' => array(
                 '0_FCLE' => Mage::helper('usa')->__('USPS First-Class Mail Large Envelope'),
                 '0_FCL'  => Mage::helper('usa')->__('USPS First-Class Mail Letter'),
                 '0_FCP'  => Mage::helper('usa')->__('USPS First-Class Mail Parcel'),
                 '0_FCPC' => Mage::helper('usa')->__('USPS First-Class Mail Postcards'),
                 '1'      => Mage::helper('usa')->__('USPS Priority Mail'),
                 '2'      => Mage::helper('usa')->__('USPS Priority Mail Express Hold For Pickup'),
                 '3'      => Mage::helper('usa')->__('USPS Priority Mail Express'),
                 '4'      => Mage::helper('usa')->__('USPS Standard Post'),
                 '6'      => Mage::helper('usa')->__('USPS Media Mail'),
                 '7'      => Mage::helper('usa')->__('USPS Library Mail'),
                 '13'     => Mage::helper('usa')->__('USPS Priority Mail Express Flat Rate Envelope'),
                 '15'     => Mage::helper('usa')->__('USPS First-Class Mail Large Postcards'),
                 '16'     => Mage::helper('usa')->__('USPS Priority Mail Flat Rate Envelope'),
                 '17'     => Mage::helper('usa')->__('USPS Priority Mail Medium Flat Rate Box'),
                 '22'     => Mage::helper('usa')->__('USPS Priority Mail Large Flat Rate Box'),
                 '23'     => Mage::helper('usa')->__('USPS Priority Mail Express Sunday/Holiday Delivery'),
                 '25'     => Mage::helper('usa')->__('USPS Priority Mail Express Sunday/Holiday Delivery Flat Rate Envelope'),
                 '27'     => Mage::helper('usa')->__('USPS Priority Mail Express Flat Rate Envelope Hold For Pickup'),
                 '28'     => Mage::helper('usa')->__('USPS Priority Mail Small Flat Rate Box'),
                 '29'     => Mage::helper('usa')->__('USPS Priority Mail Padded Flat Rate Envelope'),
                 '30'     => Mage::helper('usa')->__('USPS Priority Mail Express Legal Flat Rate Envelope'),
                 '31'     => Mage::helper('usa')->__('USPS Priority Mail Express Legal Flat Rate Envelope Hold For Pickup'),
                 '32'     => Mage::helper('usa')->__('USPS Priority Mail Express Sunday/Holiday Delivery Legal Flat Rate Envelope'),
                 '33'     => Mage::helper('usa')->__('USPS Priority Mail Hold For Pickup'),
                 '34'     => Mage::helper('usa')->__('USPS Priority Mail Large Flat Rate Box Hold For Pickup'),
                 '35'     => Mage::helper('usa')->__('USPS Priority Mail Medium Flat Rate Box Hold For Pickup'),
                 '36'     => Mage::helper('usa')->__('USPS Priority Mail Small Flat Rate Box Hold For Pickup'),
                 '37'     => Mage::helper('usa')->__('USPS Priority Mail Flat Rate Envelope Hold For Pickup'),
                 '38'     => Mage::helper('usa')->__('USPS Priority Mail Gift Card Flat Rate Envelope'),
                 '39'     => Mage::helper('usa')->__('USPS Priority Mail Gift Card Flat Rate Envelope Hold For Pickup'),
                 '40'     => Mage::helper('usa')->__('USPS Priority Mail Window Flat Rate Envelope'),
                 '41'     => Mage::helper('usa')->__('USPS Priority Mail Window Flat Rate Envelope Hold For Pickup'),
                 '42'     => Mage::helper('usa')->__('USPS Priority Mail Small Flat Rate Envelope'),
                 '43'     => Mage::helper('usa')->__('USPS Priority Mail Small Flat Rate Envelope Hold For Pickup'),
                 '44'     => Mage::helper('usa')->__('USPS Priority Mail Legal Flat Rate Envelope'),
                 '45'     => Mage::helper('usa')->__('USPS Priority Mail Legal Flat Rate Envelope Hold For Pickup'),
                 '46'     => Mage::helper('usa')->__('USPS Priority Mail Padded Flat Rate Envelope Hold For Pickup'),
                 '47'     => Mage::helper('usa')->__('USPS Priority Mail Regional Rate Box A'),
                 '48'     => Mage::helper('usa')->__('USPS Priority Mail Regional Rate Box A Hold For Pickup'),
                 '49'     => Mage::helper('usa')->__('USPS Priority Mail Regional Rate Box B'),
                 '50'     => Mage::helper('usa')->__('USPS Priority Mail Regional Rate Box B Hold For Pickup'),
                 '53'     => Mage::helper('usa')->__('USPS First-Class Package Service Hold For Pickup'),
                 '55'     => Mage::helper('usa')->__('USPS Priority Mail Express Flat Rate Boxes'),
                 '56'     => Mage::helper('usa')->__('USPS Priority Mail Express Flat Rate Boxes Hold For Pickup'),
                 '57'     => Mage::helper('usa')->__('USPS Priority Mail Express Sunday/Holiday Delivery Flat Rate Boxes'),
                 '58'     => Mage::helper('usa')->__('USPS Priority Mail Regional Rate Box C'),
                 '59'     => Mage::helper('usa')->__('USPS Priority Mail Regional Rate Box C Hold For Pickup'),
                 '61'     => Mage::helper('usa')->__('USPS First-Class Package Service'),
                 '62'     => Mage::helper('usa')->__('USPS Priority Mail Express Padded Flat Rate Envelope'),
                 '63'     => Mage::helper('usa')->__('USPS Priority Mail Express Padded Flat Rate Envelope Hold For Pickup'),
                 '64'     => Mage::helper('usa')->__('USPS Priority Mail Express Sunday/Holiday Delivery Padded Flat Rate Envelope'),
                 'INT_1'  => Mage::helper('usa')->__('USPS Priority Mail Express International'),
                 'INT_2'  => Mage::helper('usa')->__('USPS Priority Mail International'),
                 'INT_4'  => Mage::helper('usa')->__('USPS Global Express Guaranteed (GXG)'),
                 'INT_5'  => Mage::helper('usa')->__('USPS Global Express Guaranteed Document'),
                 'INT_6'  => Mage::helper('usa')->__('USPS Global Express Guaranteed Non-Document Rectangular'),
                 'INT_7'  => Mage::helper('usa')->__('USPS Global Express Guaranteed Non-Document Non-Rectangular'),
                 'INT_8'  => Mage::helper('usa')->__('USPS Priority Mail International Flat Rate Envelope'),
                 'INT_9'  => Mage::helper('usa')->__('USPS Priority Mail International Medium Flat Rate Box'),
                 'INT_10' => Mage::helper('usa')->__('USPS Priority Mail Express International Flat Rate Envelope'),
                 'INT_11' => Mage::helper('usa')->__('USPS Priority Mail International Large Flat Rate Box'),
                 'INT_12' => Mage::helper('usa')->__('USPS GXG Envelopes'),
                 'INT_13' => Mage::helper('usa')->__('USPS First-Class Mail International Letter'),
                 'INT_14' => Mage::helper('usa')->__('USPS First-Class Mail International Large Envelope'),
                 'INT_15' => Mage::helper('usa')->__('USPS First-Class Package International Service'),
                 'INT_16' => Mage::helper('usa')->__('USPS Priority Mail International Small Flat Rate Box'),
                 'INT_17' => Mage::helper('usa')->__('USPS Priority Mail Express International Legal Flat Rate Envelope'),
                 'INT_18' => Mage::helper('usa')->__('USPS Priority Mail International Gift Card Flat Rate Envelope'),
                 'INT_19' => Mage::helper('usa')->__('USPS Priority Mail International Window Flat Rate Envelope'),
                 'INT_20' => Mage::helper('usa')->__('USPS Priority Mail International Small Flat Rate Envelope'),
                 'INT_21' => Mage::helper('usa')->__('USPS First-Class Mail International Postcard'),
                 'INT_22' => Mage::helper('usa')->__('USPS Priority Mail International Legal Flat Rate Envelope'),
                 'INT_23' => Mage::helper('usa')->__('USPS Priority Mail International Padded Flat Rate Envelope'),
                 'INT_24' => Mage::helper('usa')->__('USPS Priority Mail International DVD Flat Rate priced box'),
                 'INT_25' => Mage::helper('usa')->__('USPS Priority Mail International Large Video Flat Rate priced box'),
                 'INT_26' => Mage::helper('usa')->__('USPS Priority Mail Express International Flat Rate Boxes'),
                 'INT_27' => Mage::helper('usa')->__('USPS Priority Mail Express International Padded Flat Rate Envelope'),
             ),
