...
class AS_Banner_Adminhtml_Catalog_ProductController extends Mage_Adminhtml_Catalog_ProductController
{
    ...
    public function editAction()
    {
        ...
        if($catname != "")
        {
            $prosuctName = $_product->getName();
            $product->setName(str_replace($catname." - ","",$prosuctName));
...
//            }
    ...
    public function saveAction()
    {
        ...
        Mage::log("hi category:".  json_encode($categories).$catname,NULL,'myfile.log',FALSE);
        ...
        if ($data) {
            ...
            if($catname != "")
            {
                 $product->setName($catname." - ".$data["product"]["name"]);
            }
